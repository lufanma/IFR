...
class GeneralizedRCNN(nn.Module):
    ...
    def forward(self, batched_inputs, train_step):
        """
        Args:
        ...
        if not self.training:
            return self.inference(batched_inputs, train_step=train_step)
    ...
    def inference(self,
        ...
        if detected_instances is None:
            ...
            results, _ = self.roi_heads(images, features, proposals, None, train_step)
        else:
            detected_instances = [
                x.to(self.device) for x in detected_instances
            ]
            results = self.roi_heads.forward_with_given_boxes(
                features, detected_instances, train_step)
