...
from .fast_coco_eval_api import COCOeval_opt as COCOeval
from .evaluator import BaseDatasetEvaluator
from .registry import EVALUATOR

@EVALUATOR.register()
class CustomizedCOCOEvaluator(BaseDatasetEvaluator):
    """
    ...
    def evaluate(self):
        ...
        if len(self._predictions) == 0:
            self._logger.warning("[CustomizedCOCOEvaluator] Did not receive valid predictions.")
            return {}
...
def _evaluate_predictions_on_coco(coco_gt, coco_results, iou_type, kpt_oks_sigmas=None):
    ...
    if iou_type == "keypoints":
        ...
        assert len(coco_eval.params.kpt_oks_sigmas) == num_keypoints, (
            "[CustomizedCOCOEvaluator] The length of cfg.TEST.KEYPOINT_OKS_SIGMAS (default: 17) "
